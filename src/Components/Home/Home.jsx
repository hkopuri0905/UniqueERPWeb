    ...
    <div>
      <div id ="homeIds">
        <Row className={"home-row"}>
          <Col md={3}>
            <img src="https://drive.google.com/file/d/13MKBJu29oSQcNecd-LfmFTrJNVcQ1SzM/preview" alt="Refer your Friends"/></Col>
          <Col md={9}>
        ...
        <Row className={"home-row"}>
          ...
          <Col md={3}>
            <img src="https://drive.google.com/file/d/11zDr3PLDqp5q9ExHrxFP3x-yF3wHq-zi/preview" alt="Interview Earn"/>

          </Col>
        </Row>
        <Row className={"home-row"}>
          <Col md={3}>
            <img src="https://drive.google.com/file/d/19Vwnp3ZTjplkJSWv1mB0D7kAWAPW51c6/preview" alt="My Business Image"/> </Col>
          <Col md={9}>
